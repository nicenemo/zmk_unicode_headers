 ...
 * containing extensions to the Canadian syllabics contained in the Unified
 * Canadian Aboriginal Syllabics Unicode block for some dialects of Cree ,
 * Ojibwe , Dene , and Carrier .
 * The following Unicode-related documents record the purpose and process of
 * defining specific characters in the Unified Canadian Aboriginal Syllabics
 * Extended block:
 *
...
#ifndef UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED_H
#define UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED_H
...
#endif // UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED_H
