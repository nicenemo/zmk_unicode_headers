 ...
 * Meetei Mayek Extensions are extensions to the Meetei Mayek (Unicode block)
 * containing characters for historic Meitei language orthographies.
 * The following Unicode-related documents record the purpose and process of
 * defining specific characters in the Meetei Mayek Extensions block:
 *
